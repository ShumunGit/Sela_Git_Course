...
class Date:
    ...
    def Is_valid(self):
        ...
        """ reutrn true if month is valid else false. """
    ...
    def Subtract(self, other: "Date"):
        ...
        return f"sum Days: { day + month + year }"
